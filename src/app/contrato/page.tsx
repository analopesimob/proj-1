...
export default function ContractTypeSelector() {
  ...
  return (
    <section className="bg-slate-200 min-h-screen py-16 px-8 flex flex-col items-center text-slate-900">
      <h1 className="text-4xl font-bold mb-8 text-center">Qual tipo de contrato você deseja gerar?</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl w-full">
        ...
        >
          ...
          <p className="text-slate-800 text-center">Contrato completo para transações de compra e venda de imóveis com segurança e clareza jurídica.</p>
        </span>
		</Link>
        ...
        >
          ...
          <p className="text-slate-800 text-center">Modelo de contrato ideal para locações residenciais, comerciais ou temporada, adaptado às suas necessidades.</p>
        </span>
		</Link>
        ...
        >
          ...
          <p className="text-slate-800 text-center">Revise, atualize ou corrija contratos existentes com auxílio da nossa inteligência artificial.</p>
        </div>
