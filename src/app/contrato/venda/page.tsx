import Progresso from "@/components/Stepper";
  ...
  return (
    <section className="bg-slate-200 min-h-screen py-2 md:px-1 text-white">
      ...
      <div className="flex flex-col md:flex-row gap-8">
        ...
        {/* Espaço central para empurrar o conteúdo para a direita */}
        <div className="hidden md:block"></div>
        
        {/* Coluna da direita (2/4) - Centralizada na área designada */}
        <div className="md:w-2/4 flex flex-col">
          {/* Título do contrato - Fora do quadrado branco */}
          <h1 className="text-3xl font-bold mb-6 text-center mt-16 text-slate-900">Contrato de Compra e Venda</h1>
		  <Progresso />
          
          {/* Conteúdo do contrato */}
          <div className="bg-white mt-16 text-slate-900 p-8 rounded-2xl shadow-2xl w-full">
